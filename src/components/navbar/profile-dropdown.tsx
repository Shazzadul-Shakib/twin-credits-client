  ...
  return (
    <div className="relative z-10" ref={dropdownRef}>
      ...
      >
        ...
        <ChevronDown
          className={`text-primary/70 h-4 w-4 transition-transform ${
            isOpen ? "rotate-180" : ""
          }`}
        />
      </button>
      ...
      {isOpen && (
        <div
          ...
          className="ring-opacity-5 from-primary to-secondary ring-primary/20 absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-gradient-to-b shadow-lg ring-1 focus:outline-none"
        >
