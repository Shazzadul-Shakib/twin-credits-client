...
export const ProductCard: React.FC<TProductCardProps> = ({
  ...
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-xl transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
